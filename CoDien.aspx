<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CoDien.aspx.cs" Inherits="CoDien" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table>
        ...
        <tr>
            <td style="font-family:'Courier New';"><h2>&nbsp CỔ ĐIỂN  <span class="badge rounded-pill bg-warning text-dark" style="font-family:'Courier New'">Classic</span></h2></td>
