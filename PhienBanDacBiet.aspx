<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PhienBanDacBiet.aspx.cs" Inherits="PhienBanDacBiet" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table>
        ...
        <tr>
            <td style="font-family:'Courier New';"><h2>&nbsp PHIÊN BẢN ĐẶC BIỆT  <span class="badge rounded-pill bg-warning text-dark" style="font-family:'Courier New'">Special</span></h2></td>
