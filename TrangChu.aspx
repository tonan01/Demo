...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <%--<div id="BreadCrumb" style="text-align:right">
        
         <asp:Label ID="lblXinChao" runat="server" Text="" Font-Names="Courier New" ForeColor="White" ></asp:Label>
    ...
    <table>
        ...
        <tr>
            <td style="font-family:'Courier New';"><h2>&nbsp SẢN PHẨM NỔI BẬT  <span class="badge rounded-pill bg-warning text-dark" style="font-family:'Courier New'">Featured</span></h2></td>
        ...
        <tr>
        <td>&nbsp</td>
      <td><asp:Label ID="lblKq" runat="server" Text="" Font-Names="Courier New" ForeColor="Green" Font-Size="Larger"></asp:Label></td>
          </tr>
        <tr>
            <td>&nbsp</td>
